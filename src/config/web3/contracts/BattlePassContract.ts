...
export const battlePassContract: { addressMap: { [x: number]: string }; abi: any } = {
  addressMap: {
    [SupportedChainId.ETHEREUM]: '',
    [SupportedChainId.GOERLI]: '0x910036D505Fd9FB3C4CE019ecE3f75300768dc8c',
  },
  abi: [
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: 'uint256', name: 'maxTotalSupply', type: 'uint256' }],
