  ...
  abi: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: 'uint256', name: '_mintAmount', type: 'uint256' },
      ],
      name: 'LogPublicMint',
      type: 'event',
    },
    ...
    {
      inputs: [],
      name: 'MAX_MINT_PER_WALLET_PUBLIC_PHASE',
    ...
    {
      inputs: [],
      name: 'MAX_MINT_PER_WALLET_WL_PHASE',
      outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
      stateMutability: 'view',
      type: 'function',
    },
